...
#include "images/peg_RGB565_LE.h"
...
{
	bufferDrawImage(&fb,Peg->X, Peg->Y, peg_data + (Peg->AnimPhase * TileWidth *TileHeight * sizeof(uint16_t)), TileWidth, TileHeight, false, true, false); 
}
